						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Pembayaran Operasional</h4>
								</div>
								<div class="card-body">
									...
									<form method="GET">
						                <div class="row">
						                    <div class="col-md-4">
						                      <input type="text" required="" name="komp" autocomplete="off" placeholder="NIS..." class="form-control" value="<?php echo $this->input->get('komp') ?>">
						                    </div>
						                    <div class="col-md-1">
						              ...
						              <?php if($this->input->get('komp')){ ?>
						                      ...
						                      <form method="POST" action="<?php echo site_url('insert_pembayaranBulanan') ?>">
						                                ...
						                                <div class="card-body">
						                                  ...
						                                  <table class="table">
						                                    <tr>
						                                      ...
						                                      <td style="width:30%"><?php echo $siswa['nama_lengkap']."<br><small>NIS : ". $siswa['nis'] ."</small>"; ?></td>
						                                    ...
						                                    <tr>
						                                      ...
						                                      <th style="width:20%; background-color: #eee;">Kelas</th>
						                                ...
						                                <?php 
						                                      ...
						                                      foreach ($pembayaran as $row) { $final = $row['nominal']; $n++; ?>
						                                        <tr>
						                                          ...
						                                          <td><?php echo $row['nama_komponen']." ".get_monthname(date('m', strtotime($row['tanggal_transaksi']))) ?></td>
