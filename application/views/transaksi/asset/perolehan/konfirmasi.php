<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Asset</h4> &emsp; <small><b>Perolehan</b></small>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Konfirmasi Barang Tiba</a>
							</li>
						</ul>
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Daftar Konfirmasi</h4>
								</div>
								<div class="card-body">
									...
									<form method="GET">
										<div class="row">
											<div class="col-md-4">
												...
												<select required="" class="form-control" name="perolehan_id">
													<option value="">Pilih</option>
													<?php foreach ($list as $row) { ?>
															<option <?php if($row['id'] == $this->input->get('perolehan_id')){ echo "selected='selected'"; } ?> value="<?php echo $row['id'] ?>"><?php echo $row['kode_transaksi']?></option>
													<?php } ?>
												</select>
											</div>
									...
									<?php if($this->input->get('perolehan_id')){ ?>

									<br>

									<form method="POST" action="<?php echo site_url('set_retur/'.$this->input->get('perolehan_id')) ?>">
											...
											<table class="display table table-hover datatables" >
												<thead style="background-color: #eee">
													<tr>
														...
														<th>Aktiva</th>
														<th class="text-center" style="width: 5%">Retur</th>
													</tr>
												</thead>
												<tbody>
													<?php 
