						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<h4 class="card-title">Daftar Pendanaan Keluar</h4>
								</div>
								<div class="card-body">
									...
									<ul class="nav nav-pills nav-secondary  nav-pills-no-bd nav-pills-icons" id="pills-tab-with-icon" role="tablist">
										...
										<li class="nav-item">
											<a class="nav-link" id="pills-profile-tab-icon" data-toggle="pill" href="#pills-profile-icon" role="tab" aria-controls="pills-profile-icon" aria-selected="false">
												<img style="width: 25px" src="<?php echo base_url('assets/img/icon/list.png') ?>"> Daftar Pengeluaran
											</a>
										</li>
									</ul>
								                          ...
								                          foreach ($req as $row) { $n++; ?>
								                            ...
								                            <tr>
								                              ...
								                              <td class="text-center">
								                                  ...
								                                  <a href="<?php echo site_url('transaksi/keuangan/cash_out/detail/'.$row['id']) ?>" data-toggle="tooltip" title="Lihat Detail" class="btn btn-primary btn-sm shadow">
